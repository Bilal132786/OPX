...
for z in range(200):
	...
	ua = f"Dalvik/2.1.0 (Linux; U; Android 6.0.1; ASUS_Z012DA Build/MMB29P)"
...
|  _ <'| || |  _ |  _  || |  _      {P2}██████████████████████[/]
| (_) )| || |_( )| | | || |_( )   
(____/'(_)(____/'(_) (_)(____/'  Made By {M2}Indonesia {P2}Coder
{color_text}╭──────────────────────╮{color_text}╭───────────────╮{color_text}╭────────────────────────────╮
{color_text}│ {P2}Recode by: BILAL-XD {color_text}│{color_text}│ {P2}Version : 2.0 {color_text}│{color_text}│ {P2}Fall Xavier Script {color_text}│
